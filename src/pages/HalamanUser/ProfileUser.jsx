...
import CoverImage from '../../assets/gambarUser/gambar.png';
import ProfilePic from '../../assets/gambarUser/belavina.png';
        ...
        <div className="max-w-6xl mx-auto p-4 md:p-8">
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-6">
              {/* Sidebar Menu with Feedback */}
              <div className="flex flex-col justify-between border p-4 rounded-md border-[#E9EBEC] h-full min-h-[300px]">
                {/* Menu Items */}
          ...
          ${activeTab === item.id
                ...
                <div className="mt-6">
                  <button
                    ...
                    className="w-full border border-[#EE628B] text-[#EE628B] hover:bg-[#EE628B] hover:text-white py-2 rounded-md text-sm transition-colors"
                  >
                    💬 Berikan Feedback
                  </button>
                </div>
