  ...
  const orders = [
    {
      ...
      customerEmail: 'sarah.putri@gmail.com',
    ...
    },
    {
      ...
      customerEmail: 'maya.ang@yahoo.com',
      orderDate: '2024-06-22',
      status: 'shipped',
      items: 2,
      total: 325000,
    ...
    },
    {
      ...
      customerEmail: 'dewi.kartika@gmail.com',
    ...
    },
    {
      ...
      customerEmail: 'linda.w@gmail.com',
      orderDate: '2024-06-21',
      status: 'pending',
      items: 1,
      total: 150000,
    ...
    },
    {
      ...
      customerEmail: 'rina.s@outlook.com',
    ...
    <main className="flex-1 p-6 bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-green-500">
          ...
          <p className="text-2xl font-bold text-green-600">Rp {(stats.revenue / 1000000).toFixed(1)}M</p>
              ...
              {filteredOrders.map((order) => {
                ...
                return (
                  <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-3 py-1 inline-flex items-center text-xs leading-5 font-semibold rounded-full ${statusConfig[order.status].color}`}>
